...
1. Simple driving Game with Portrait perspective
...
2. The game is implemented with both Score & Energy System. The energy takes 1 min to refill and the duration is adjustable.
...
3. The notification system is implemented for both Andriod & IOS platforms and the notification will pop-up after energy is filled.
...
4. The player (Car) is controlled by using New Input System (Simulate Touch), Event Triggers component (OnPointerEnter & OnPointerExit) to press and release touches for both left and right side.
...
5. Using Cinemachine can achieve more advanced and handier features such as Follow & Look At, Body and Aim Offsets.
...
6. Gameplay contains maps and obstacles to avoid. Plus, the In-App-Purchase feature to change the car models.
