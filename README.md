...
3. The player (Car) is controlled by using New Input System (Simulate Touch), Event Triggers component (OnPointerEnter & OnPointerExit) to press and release touches for both left and right side.
